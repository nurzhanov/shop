						...
						switch($action){
								...
								<div class="row">
									<div class="cols col-12">
										<div id="block-step">
											<div id="name-step">
												<ul>
													<li><a href="cart_copy.php?action=oneclick">1.Cart</a></li>
									...
									<div class="cols col-12">
										<div id="block-step">
											<div id="name-step">
												<ul>
													<li><a href="cart_copy.php?action=oneclick">1.Cart</a></li>
													<li><a href="cart_copy.php?action=confirm">2.Contacts</a></li>
							...
							default:
								...
								<div class="row">
									<div class="cols col-12">
											<p class="nmb_step">Step 1 of 3</p>
											<a class="logbutton" id="clear_cart" href="cart.php?action=clear">Clear</a>
									</div>
								</div>
								';
								break;
